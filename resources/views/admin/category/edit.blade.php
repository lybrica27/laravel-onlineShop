	...
	<section class="content">
		...
		<div class="container-fluid">
            ...
            <form action="" method="post" id="categoryForm" name="categoryForm">
                <div class="card">
			    	<div class="card-body">								
			    		<div class="row">
                            ...
                            <!-- show image for editing -->
                            @if(!empty($category->image))
                                <div>
                                    <img width="250" src="{{ asset('uploads/category/thumb/' . $category->image) }}" alt="crop-img">
                                </div>
                            @endif
                            <!-- end show image for editing -->
                ...
                <div class="pb-5 pt-3">
				    <button type="submit" class="btn btn-primary" id="upload-button">Update</button>
...
@section('script')
    <script>
        ...
        //     },
        //     autoProcessQueue: false, // Set this option to false to stop automatic upload
        //     success: function(file, response){
        //         $("#image_id").val(response.image_id);
        //     }
        // });

        // // Manually trigger the upload when needed

                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="slug" name="slug" id="slug" class="form-control" placeholder="slug">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <input value="Yes" class="custom-control-input" type="checkbox" id="track_qty" name="track_qty" checked>

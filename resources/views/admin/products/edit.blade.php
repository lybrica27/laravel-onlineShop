                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="slug" value="{{ $products->slug }}" name="slug" id="slug" class="form-control" placeholder="slug">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                @foreach ($productImages as $image)
                                    <div class="col-md-3" id="image-row-{{$image->id}}" >
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <a href="#" class="btn btn-danger" onclick="deleteImage( {{$image->id}} )">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="price" id="price" class="form-control" value="{{ $products->price }}" placeholder="Price">
                                            <p class="error"></p>	
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <input value="Yes" class="custom-control-input" type="checkbox" id="track_qty" name="track_qty" {{ ($products->track_qty == 'Yes') ? 'checked':'' }}>
        ...
        const dropzone = $("#image").dropzone({
            ...
            success: function(file, response){
                ...
                var html = `<div class="col-md-3" id="image-row-${response.image_id}" ><div class="card">
                                ...
                                <div class="card-body">
                                    <a href="#" class="btn btn-danger" onclick="deleteImage(${response.image_id})">Delete</a>
                                </div>
                            </div></div>`;

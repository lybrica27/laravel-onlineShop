                                ...
                                @if( $categories->isNotEmpty() )
                                    @foreach( $categories as $category )
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapse{{ $category->id }}" class="accordion-collapse collapse {{ ($categorySelected == $category->id)? 'show':'' }}" aria-labelledby="heading{{ $category->id }}" data-bs-parent="#accordionExample" style="">
                            ...
                            @if( $brands->isNotEmpty() )
                                @foreach( $brands as $brand )
                                    <div class="form-check mb-2">
                                        <input {{ (in_array($brand->id, $brandsArray)) ? 'checked':'' }} class="form-check-input brand-label" type="checkbox" name="brand[]" value="{{ $brand->id }}" id="{{ $brand->id }}">
                        ...
                        <div class="col-12 pb-1">
                            <div class="d-flex align-items-center justify-content-end mb-4">
                                <div class="ml-2">
                                    ...
                                    <select name="sort" id="sort" class="btn btn-sm btn-light dropdown-toggle">
...
@section('script')
    <script> 
        ...
        $(".brand-label").change(function(){                //for range slider
            apply_filters();
        });

        $("#sort").change(function(){                       //for price sorting 
            apply_filters();
        });
